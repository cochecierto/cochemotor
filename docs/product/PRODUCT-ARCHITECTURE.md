# Arquitectura del Producto — VendoCoche360

## Orientación General
La arquitectura de VendoCoche360 se organiza por capas modulares diseñadas para maximizar la velocidad comercial, la rotación de stock de vehículos de ocasión (VO) y la trazabilidad operativa y legal en España.

## Capas Funcionales

1. **Espacio Privado del Compraventa / Concesionario (`app.vendocoche360.es`)**:
...
2. **Escaparate y Fichas Públicas Compartibles (`vendocoche360.es/v/:slug`)**:
